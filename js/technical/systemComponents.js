var systemComponents = {
	...
	'overlay-head': {
		...
		<br>
		<span v-if="player.points < Infinity"  class="overlayThing">You have </span>
		<h2  class="overlayThing" id="points">{{format(player.points)}}</h2>
		<span v-if="player.points < Infinity"  class="overlayThing"> {{modInfo.pointsName}}</span>
		<br>
    ...
    'info-tab': {
        ...
        <br>
        The Modding Tree <a v-bind:href="'https://github.com/Distort-Cubic/The-Modding-Tree/blob/master/changelog.md'" target="_blank" class="link" v-bind:style = "{'font-size': '14px', 'display': 'inline'}" >{{TMT_VERSION.tmtNum}}</a> by Acamaeda and FlamemasterNXF
        <br>
